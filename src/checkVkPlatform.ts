 ...
 * - desktop - десктопное нативное приложение VK Мессенджер (можно скачать на @see https://vk.me/app для платформ Windows, MacOS или Linux).
 * - desktop web - открытый в десктопном браузере сайт ВКонтакте (vk.com) или VK Мессенджера (web.vk.me)
